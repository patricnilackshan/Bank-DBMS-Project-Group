...
export function CreateManager() {
    ...
    //                 <form className="Auth-form" action="/Admin">
    //                     <div className="Auth-form-content">
    //                         <h3 className="Auth-form-title" align="center">Fill the details of the manager</h3>
    ...
    //                         <br>
    //                         <button className="backbutton" formAction="/Admin" type="submit" color=green><span>Back </span></button>
